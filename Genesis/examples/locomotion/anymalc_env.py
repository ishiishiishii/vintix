...
class ANYmalCEnv:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False,
        ...
        self.robot = self.scene.add_entity(
            gs.morphs.URDF(
                file="/workspace/Genesis/genesis/assets/urdf/anymal_c/urdf/anymal_c.urdf",
    ...
    def _reward_base_height(self):
        # Penalize base height away from target (Go2と同様の形式)
    ...
    def _save_original_physics(self):
        ...
        try:
            ...
            self.original_mass = 6.222  # Default value (ANYmalC base mass from URDF)
