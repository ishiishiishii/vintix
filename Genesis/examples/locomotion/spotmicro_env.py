...
class SpotMicroEnv:
    ...
    def _resample_commands(self, envs_idx):
        ...
        # base_init_quatは単一のクォータニオンなので、すべての環境に適用
    ...
    def step(self, actions):
        ...
        # 転倒判定: ベース高さが設定値以下になったら終了
        if "termination_if_base_height_below" in self.env_cfg:
            self.reset_buf |= self.base_pos[:, 2] < self.env_cfg["termination_if_base_height_below"]
    ...
    def _save_original_physics(self):
        ...
        try:
            ...
            self.original_mass = 1.20  # Default value (SpotMicro base mass)
